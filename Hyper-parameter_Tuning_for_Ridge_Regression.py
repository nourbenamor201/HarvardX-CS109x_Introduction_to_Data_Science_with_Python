...
ax.plot(training_error,alphas,'s--', label = 'Training error',color = 'Darkblue',linewidth=2)

# Plot the validation errors for each alpha value

ax.plot(validation_error,alphas,'s-', label = 'validation error',color ='#9FC131FF',linewidth=2 )
