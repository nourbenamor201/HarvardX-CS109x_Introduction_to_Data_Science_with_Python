...
dt1_train_preds = dt1.predict(X_train)
dt1_test_preds = dt1.predict(X_test)

dt1_train_acc = accuracy_score(y_train, dt1_train_preds)
dt1_test_acc = accuracy_score(y_test, dt1_test_preds)

# Compute the train and test accuracy for the second decision tree classifier of depth 10
dt2_train_preds = dt2.predict(X_train)
dt2_test_preds = dt2.predict(X_test)

dt2_train_acc = accuracy_score(y_train, dt2_train_preds)
dt2_test_acc = accuracy_score(y_test, dt2_test_preds)
...
dt3_test_preds = dt3.predict(X_test)

dt3_train_acc = accuracy_score(y_train, dt3_train_preds)
dt3_test_acc = accuracy_score(y_test, dt3_test_preds)
