...
ax.plot(df['longitude'][y == 1], df['latitude'][y == 1], 'o',c='green', markersize=9,label='Agricultural lands')

# Repeat the same, but for y==0

ax.plot(df['longitude'][y == 0], df['latitude'][y == 0], 'o',c='brown', markersize=9,label='Dry lands', alpha=0.3)
