...
trump_data = elect_train[elect_train['trump'] > elect_train['clinton']]
clinton_data = elect_train[elect_train['trump'] <= elect_train['clinton']]

# Plot "minority" vs "bachelor"
plt.scatter(trump_data['minority'], trump_data['bachelor'], marker=".", color="blue", label="Trump", s=50, alpha=0.4)
plt.scatter(clinton_data['minority'], clinton_data['bachelor'], marker=".", color="green", label="Clinton", s=50, alpha=0.4)
